...
myst_html_meta = {
    "description": "IP2Location OpenResty Package provides a fast lookup of geolocation information from IP address by using IP2Location database.",
    "keywords": "IP2Location, Geolocation, IP location, OpenResty",
...
html_title = "IP2Location OpenResty"

# html_baseurl = "https://ip2location-resty.readthedocs.io/en/latest/"